        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                buildDetailBox("Puan", book.rating, context),
                buildDetailBox("Basım Yılı", book.yearRelease, context),
                buildDetailBox("Sayfa", book.pages, context),
            ...
            Row(
              ...
              children: [
                Text(
                  book.price <= 0 ? "Ücretsiz" : "${book.price} ₺",
